...
@JavaClass("java.lang.Long", extends: JavaNumber.self)
public struct JavaLong {
  @JavaMethod
  public init(_ arg0: String, environment: JNIEnvironment? = nil) throws

  @JavaMethod
  public init(_ arg0: Int64, environment: JNIEnvironment? = nil)
  ...
  @JavaMethod
  public func compareTo(_ arg0: JavaLong?) -> Int32
